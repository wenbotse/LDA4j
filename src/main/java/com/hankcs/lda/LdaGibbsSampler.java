...
public class LdaGibbsSampler {
	 ...
	 * 文档——主题参数
	 */
	double alpha = Double.parseDouble(ConfigTool.props.getProperty("alpha",
			"2.0"));
	 ...
	 * 主题——词语参数
	 */
	double beta = Double.parseDouble(ConfigTool.props
			.getProperty("beta", "0.5"));;
	 ...
	 * 最大迭代次数
	 */
	private static int ITERATIONS = Integer.parseInt(ConfigTool.props
			.getProperty("iteration", "1000"));
